...
The repository contains the VAMPIRE input files used for the domain wall motion simulations used in the paper "Mechanical Resonant Sensing of Spin Texture Dynamics in a 2D Antiferromagnet" (https://doi.org/10.1002/adma.202420168).
